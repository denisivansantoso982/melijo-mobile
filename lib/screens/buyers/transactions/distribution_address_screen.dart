...
class _DistributionAddressScreenState extends State<DistributionAddressScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _loadingAddress ? const Center(
        child: SizedBox(
          width: 56,
          height: 56,
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton(
          style: ElevatedButton.styleFrom(
            backgroundColor: _loadingAddress ? Colours.gray : Colours.deepGreen,
          ),
          onPressed: () {
            if (!_loadingAddress) {
              if (!_isCommited) {
          ...
          child: Text(
            _loadingAddress ? 'Memuat Halaman...' : _isCommited ? 'Lanjut ke Pembayaran' : 'Simpan Detail Pengiriman',
            style: const TextStyle(
              fontWeight: FontStyles.medium,
              fontFamily: FontStyles.leagueSpartan,
              fontSize: 18,
