                  ...
                  body: Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) => CheckboxListTile(
                        title: Text(
                            '${_promoList[index].promo_title} (Rp. ${thousandFormat(_promoList[index].promo_total)})'),
                        value: _promoList[index].checked,
                        activeColor: Colours.deepGreen,
                        onChanged: (value) {
                          setState(() {
                            for (PromoBuyersModel promo in _promoList) {
                              if (promo == _promoList[index]) {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    'Rp. ${thousandFormat(totalProduct())} ${(_promoList.where((element) => element.checked).isNotEmpty ? '(- Rp. ${thousandFormat(_promoList.firstWhere((element) => element.checked).promo_total)})' : '')}',
                    style: const TextStyle(
                      color: Colours.black,
                      fontSize: 16,
                      fontWeight: FontStyles.bold,
